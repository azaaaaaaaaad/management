...
import { auth } from "@/app/auth"; // Uncomment if auth is available and needed

async function TeacherProfile() {
  // Uncomment and use the session if auth is implemented
  // const session = new auth();
  // console.log("Teacher profile session::", session);
    ...
    <div className="max-w-sm mx-auto p-6 bg-gradient-to-r from-blue-500 to-purple-500 shadow-lg rounded-lg hover:shadow-2xl transition-shadow duration-300">
      ...
      <div className="mt-4">
        <p className="text-gray-100 text-center">
          Graduated with a B.Sc. in Mathematics from XYZ University. Passionate about teaching and helping students
          excel.
        </p>
      </div>
